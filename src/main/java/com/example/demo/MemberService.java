...
@Service		//자동으로 스캔되도록 붙임
public class MemberService implements UserDetailsService {

	//패스워드 인코딩을 위한 객체를 선언해요
	//이 객체는 bit securityApplicatrion 클래스에서 제공되는 개개체를 자동으로 의존관계 설정해요.
	@Autowired
	...
	//컨트롤러 준 vo에 들어있는 패스워드를 인코딩하여 다시 vo에 담아요
	...
	//매개변수로 전달받은 username에 해당하는
		...
		//우리가 db로 부터 뽑아온 회원의 정보를 스피링 시큐리티가 인증절차를 할수있는 객체로 만들어 일을 맡김
